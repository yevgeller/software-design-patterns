...
//  currentStatus: string;
  ...
  constructor(id: string = 'N/A', description: string = 'N/A', assignedTechnician: string = 'N/A', assignedQA: string="N/A" ) {
      this.id = id;
...
class SupportTicketState_New extends SupportTicketState {
  ...
  moveForward(info: string): void {
    this.ticket.currentState = new SupportTicketState_TechnicianAssigned(info, this.ticket) 
  }
  moveBack(): void {
...
class SupportTicketState_TechnicianAssigned extends SupportTicketState {
  ...
  moveBack(): void {
      ...
      this.ticket.currentState = new SupportTicketState_New(new SupportTicket(this.ticket.id, this.ticket.description))
  }
}
